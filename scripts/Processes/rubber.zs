...
//Primal process
mods.primal.Cauldron.addRecipe("Formic_acid", 5, null, <liquid:formicacid> * 100, [<forestry:bee_drone_ge:*>], [<forestry:ash>]);
mods.primal.Cauldron.addRecipe("Raw_rubber", 5, <liquid:formicacid> * 50, null, [<ic2:misc_resource:4>], [<contenttweaker:rawrubber>]);
...
mods.betterwithmods.Cauldron.addUnstoked([<contenttweaker:driedrawrubber>, <betterwithmods:material:37>, <railcraft:dust:1>],[<ic2:crafting>*6]);

//Early Industrial process - need to gate forestry devices further
mods.forestry.Squeezer.addRecipe(<liquid:formicacid>*120, [<forestry:bee_drone_ge:*>], 100);
