...
//TG final assembly
mods.techguns.MetalPress.addRecipe(<materialpart:iron:gearpart>, <railcraft:gear:3>, <materialpart:iron:gear>, true);
mods.techguns.MetalPress.addRecipe(<materialpart:steel:gearpart>, <railcraft:gear:3>, <materialpart:steel:gear>, true);
mods.techguns.MetalPress.addRecipe(<materialpart:bronze:gearpart>, <railcraft:gear:3>, <materialpart:bronze:gear>, true);
mods.techguns.MetalPress.addRecipe(<materialpart:invar:gearpart>, <railcraft:gear:3>, <materialpart:invar:gear>, true);
